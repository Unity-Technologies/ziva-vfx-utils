...
latex_documents = [
    (master_doc, 'zBuilder.tex', u'zBuilder Documentation',
     u'Ziva Dynamics', 'manual'),
]
...
man_pages = [
    (master_doc, 'zbuilder', u'zBuilder Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'zBuilder', u'zBuilder Documentation',
     author, 'zBuilder', 'One line description of project.',
     'Miscellaneous'),
]
