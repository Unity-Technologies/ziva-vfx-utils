...
and then with zBuilder you can save that state and save it out and re-build it.
...
If the new geometry's topology (i.e.: triangles, number of vertices) is different from the original rig,
