...
icons['zAttachment_s'] =      'icons\\zAttachment.xpm'
icons['zAttachment_t'] =      'icons\\zAttachment.xpm'
...
icons['zCacheTransform']=            'icons\\zFiber.xpm'
...
QTreeView::branch:has-siblings:!adjoins-item {
    border-image: url("C:/ziva/dev/Maya/scripts/zUI/icons/stylesheet-vline.xpm") 0;
}

QTreeView::branch:has-siblings:adjoins-item {
    border-image: url("C:/ziva/dev/Maya/scripts/zUI/icons/stylesheet-branch-more.xpm") 0;
}

QTreeView::branch:!has-children:!has-siblings:adjoins-item {
    border-image: url("C:/ziva/dev/Maya/scripts/zUI/icons/stylesheet-branch-end.xpm") 0;
}

QTreeView::branch:has-children:!has-siblings:closed,
QTreeView::branch:closed:has-children:has-siblings {
        border-image: none;
        image: url("C:/ziva/dev/Maya/scripts/zUI/icons/cross.xpm");
}

QTreeView::branch:open:has-children:!has-siblings,
QTreeView::branch:open:has-children:has-siblings  {
        border-image: none;
        image: url("C:/ziva/dev/Maya/scripts/zUI/icons/line.xpm");
}
'''
